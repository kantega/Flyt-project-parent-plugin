...
public class GenerateProjectParentMojo extends AbstractMojo {
    ...
    public void execute() throws MojoFailureException {
        ...
        try {
            String projectParent = IOUtils.toString(getClass().getResource("/pom.template"));
            ...
            File projectParentFile = new File(System.getProperty("java.io.tmpdir"), "projectparentpom.xml");
